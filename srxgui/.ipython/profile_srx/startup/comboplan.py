...
def my_xanes(x_motor = 0 , y_motor = 0 , z_motor = 0, e_range = [], e_steps = [], E_0 = 0., k_range = [], k_steps = [], dwell = 1, samplename='', filename='', ax11 = None, ax22 = None, ax33 = None):
    ...
    yield from exafs_plan(erange = e_range, estep = e_steps,  E0 = E_0, krange = k_range,kstep = k_steps, acqtime = dwell, ax1 =ax11, ax2 = ax22, ax3 = ax33)


def exafs_plan(erange=[], estep=[], E0=0., krange=[], kstep=[],
