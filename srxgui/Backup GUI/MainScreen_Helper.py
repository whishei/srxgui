...
def collect_args(ax11 = None, ax22 = None, ax33 = None):
    ...
    #WORK ON THISSSSSSS
        ...
        return 'S', (), {'x_motor': xmotor, 'y_motor': ymotor, 'z_motor': zmotor, 'e_range': erange.tolist(), 'e_steps': estep.tolist(),  'E_0': E0, 'k_range': krange,
                'k_steps': kstep, 'dwell': acqtime, 'samplename': sample,
                'filename': file, 'ax11': ax1, 'ax22': ax2, 'ax33': ax3}
    else:
        return 'S', (), {'x_motor': xmotor, 'y_motor': ymotor, 'z_motor': zmotor, 'e_range': erange.tolist(), 'e_steps': estep.tolist(),  'E_0': E0, 'k_range': krange.tolist(),
...
def add_xrf_to_queue():
    ...
    return 'X', (xstart, xstop, xnum, ystart, ystop, ynum), {}
